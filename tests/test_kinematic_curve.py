"""
Tests for kinematic_curve against digitized data from Krane "Introductory Nuclear Physics".
...
def test_kinematic_curve_vs_krane(data_file):
    """
    Validate kinematic_curve E3 output against digitized Krane data.
